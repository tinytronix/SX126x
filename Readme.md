...
Most of the hardware driver software is taken from https://github.com/jgromes/RadioLib (Universal wireless communication library for Arduino, great project!). I only adapted RadioLib basic driver to run completely in the Adruino main loop without any interrupts - see examples)
